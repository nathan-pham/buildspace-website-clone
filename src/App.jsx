            ...
            <main>
                <Section backgroundImage="/section1.png" variant="grayscale">
                    ...
                    <SectionSubtitle className="mt-10">
                        ...
                        to come together, explore promising domains and ship
                        meaningful products.
                    </SectionSubtitle>
                ...
                <Section backgroundImage="/section2.png">
                    ...
                    <SectionSubtitle>
                        web3, machine learning, artificial intelligence and
                        other promising domains like robotics, no-code and music
                        coming soon.
                    </SectionSubtitle>
                </Section>
                <Section backgroundImage="/section3.png">
                    ...
                    <SectionSubtitle>
                        A weekend is all it takes to activate yourself. All
                        projects are specifically designed to be finished over a
                ...
                <Section backgroundImage="/section4.png">
                    ...
                    <SectionSubtitle>
                        Join a select group of builders that are working on
                        their dreams on nights & weekends. Learn from those that
                        have done it. Build with those that don't give up.
                    </SectionSubtitle>
                ...
                <Section backgroundImage="/section5.png">
                    ...
                    <SectionSubtitle>
                        ...
                        shit. Make friends. Set ambitious goals and climb your
                        inner mountain. You got this!
                    </SectionSubtitle>
                    <Button variant="md hollow" className="mt-20">
                        'Sup on the cord
                    </Button>
